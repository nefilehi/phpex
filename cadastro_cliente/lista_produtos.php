                    ...
                    <tr>
                        ...
                        <td>
                            <?php if (!empty($produto['imagem'])): ?>
                                <img src="img/<?= htmlspecialchars($produto['imagem']) ?>"></img>
                            <?php else: ?>
                        ...
                        <td>
                            <?php if ($temAcessoAdmin): ?>
                                ...
                                <a href="excluir_produto.php?id=<?= $produto['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('A exclusão é permanente! Tem certeza disso?')">Excluir</a>
                            <?php else: ?>
